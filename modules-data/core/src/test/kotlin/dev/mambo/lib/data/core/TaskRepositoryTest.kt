...
class TaskRepositoryTest {
    ...
    @Test
    fun `createTask should add a new entry`() =
        runTest {
            val list =
                mutableListOf(
                    TaskDomain(
    ...
    @Test
    fun `updateTask should update an existing entry`() =
        runTest {
            val list =
                mutableListOf(
                    TaskDomain(
    ...
    @Test
    fun `deleteTask should remove an existing entry`() =
        runTest {
            val list =
                mutableListOf(
                    TaskDomain(
    ...
    @Test
    fun `getTasks should return a list of entries`() =
        runTest {
            val list =
                (1..5).map {
                    TaskDomain(
    ...
    @Test
    fun `getTask should return a single entry`() =
        runTest {
            val list =
                (1..5).map {
                    TaskDomain(
